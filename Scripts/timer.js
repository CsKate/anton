...
function setDateObject() {
  ...
  let weddingDate = new Date("May 28, 2022 14:00:00").getTime();
...
setDateObject();
//ezt majd le kell rendesen tesztelni, és ha csak azért csúszik el, mert az egy másodperc igaziból nem egy,
//akkor egy setInterval-t tenni a setDateObject-re is.
...
function timer() {
  ...
  let dayThirdDigit =
    dateObject.day - dayFirstDigit * 100 - daySecondDigit * 10;
